...
void ICM20602::ICM20602_WriteByte(uint8_t ICM20602_reg, uint8_t ICM20602_data)
{
    // char data_out[2];
    // data_out[0] = ICM20602_reg;
    // data_out[1] = ICM20602_data;
    // ICM20602_i2c.write(ICM20602_slave_addr, data_out, 2, 0);
    _i2cPort->beginTransmission(ICM20602_slave_addr);
    _i2cPort->write(ICM20602_reg);
    _i2cPort->write(ICM20602_data);
    _i2cPort->endTransmission();
}

uint8_t ICM20602::ICM20602_ReadByte(uint8_t ICM20602_reg)
{
    ...
    _i2cPort->requestFrom((uint8_t)ICM20602_slave_addr, (uint8_t)1); // Request 1 byte
...
void ICM20602::whoAmI()
{
    ...
    Serial.printf("I AM ICM20602: 0x%x \r\n", whoAmI);

    if (whoAmI == 0x12) // 0x68)
    {
        Serial.printf("ICM20602 is online... \r\n");
        //        led2=1;
        //        ledToggle(2);
    }
    else
    {
        Serial.printf("Could not connect to ICM20602 \r\nCheck the connections... \r\n");
        //        toggler1.attach(&toggle_led1,0.1);     // toggles led1 every 100 ms
    }
}

void ICM20602::init(TwoWire &wirePort, uint32_t i2cSpeed)
{
    _i2cPort = &wirePort;
    // _i2caddr = 0x68;
