...
#define SCREENW         CANVAS_W
#define SCREENH         CANVAS_W
#define HALFW            (CANVAS_W/2)
#define HALFH            (CANVAS_W/2)
#define FOV              64
...
// ----------------------------------------------
void ClockModel::draw_vertex(const uint16_t color, lv_obj_t* canvas)
{
    int i = NODECOUNT - 1;
...
// ----------------------------------------------
void ClockModel::draw_wireframe(const uint16_t color, lv_obj_t* canvas)
{
    int i = TRICOUNT - 1;
    lv_canvas_fill_bg(canvas, COLOR1, LV_OPA_COVER);
...
// ----------------------------------------------
void ClockModel::draw_flat_color(const int(* n)[2], uint16_t color, lv_obj_t* canvas)
{
    int i = TRICOUNT - 1;
    int surface;
    uint16_t col = color;
...
// ----------------------------------------------
void ClockModel::clear_dirty(const int(* n)[2], lv_obj_t* canvas)
{
...
void ClockModel::Update(lv_obj_t* canvas)
{
    // rotation
...
{
    // account = new Account("ClockModel", AccountSystem::Broker(), 0, this);
