...
//
// /*
//  *  函数名：   void lv_100ask_stm32_game_snake(void)
//  *  输入参数： 无
//  *  返回值：   无
//  *  函数作用： 应用初始化入口
// */
...
//         if (i == 0)
//         {
//             lv_obj_set_style_local_bg_color(head->obj, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, LV_100ASK_GAME_SNAKE_HEAD_COLOR); //设置颜色
//         }
//         else
//             lv_obj_set_style_local_bg_color(head->obj, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, LV_100ASK_GAME_SNAKE_BODY_COLOR); //设置颜色
//         lv_obj_set_style_local_radius(head->obj, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, LV_100ASK_GAME_SNAKE_RADIUS);  		 // 设置圆角
...
//     lv_obj_set_style_local_bg_color(g_pt_lv_100ask_snake->obj_food, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, LV_100ASK_GAME_FOOD_COLOR); //设置颜色
//     lv_obj_set_style_local_radius(g_pt_lv_100ask_snake->obj_food, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, LV_100ASK_GAME_FOOD_RADIUS);	// 设置圆角
...
// 	lv_obj_set_style_local_text_font(g_pt_lv_100ask_snake->label_info, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &lv_font_montserrat_14);  		// 设置字体格式
...
//     lv_obj_set_style_local_bg_color(list_new->obj, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, LV_100ASK_GAME_SNAKE_BODY_COLOR); //设置颜色
//     lv_obj_set_style_local_radius(list_new->obj, LV_OBJ_PART_MAIN, LV_STATE_DEFAULT, LV_100ASK_GAME_SNAKE_RADIUS);  // 设置圆角
...
//     {
//         if (g_pt_lv_100ask_snake->task_handle != NULL)	lv_task_del(g_pt_lv_100ask_snake->task_handle);  // 删除任务.
...
// 		
// 		/* 删除蛇身 */
//         lv_100ask_stm32_game_snake_clear_list((spriteSnake));  		// 清空链表
