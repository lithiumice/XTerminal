...
bool updateLogo(void)
{
    ...
    arduboy_game1.setRGBled(0, 0, signalOn * 127);
    bool ret = (counter == 0);
    if (ret) {
...
void drawLogo(void)
{
    ...
    for (int i = 0; i < 3; i++) {
        ...
        arduboy_game1.drawBitmap(28 + i * 24, y, imgOBN[i], 24, 32, WHITE);
    }
    arduboy_game1.drawBitmap(68, 44, imgSoft, 32, 8, WHITE);
    arduboy_game1.printEx(16, 58, F(APP_INFO));
    arduboy_game1.printEx(7, 0, F("FOR 2ND #ARDUBOYJAM"));
}
