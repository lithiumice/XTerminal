...
void chribocchi_setup()
{
#ifdef DEBUG
    Serial.begin(115200);
#endif
    arduboy_game1.beginNoLogo();
    arduboy_game1.setFrameRate(60);
    moduleTable[LOGO_MODE].initFunc();
}

void chribocchi_loop()
{
#ifdef DEBUG
    dbgCheckSerialRecv();
#endif
    if (!(arduboy_game1.nextFrame())) return;
